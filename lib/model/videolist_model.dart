...
class VideosList {
  ...
  factory VideosList.fromJson(Map<String, dynamic> json) => VideosList(
        ...
        videos: null == json["items"]
            ? null
            : List<VideoItem>.from(
                json["items"].map((x) => VideoItem.fromJson(x))),
        pageInfo: null == json["pageInfo"]
            ? null
...
class VideoItem {
  ...
  factory VideoItem.fromJson(Map<String, dynamic> json) => VideoItem(
        ...
        etag: json["etag"],
        id: json["id"],
        video: null == json["snippet"] ? null : Video.fromJson(json["snippet"]),
      );
...
class Video {
  ...
  factory Video.fromJson(Map<String, dynamic> json) => Video(
        ...
        thumbnails: null == json["thumbnails"]
            ? null
...
class Thumbnails {
  ...
  factory Thumbnails.fromJson(Map<String, dynamic> json) => Thumbnails(
        thumbnailsDefault:
            null == json["default"] ? null : Default.fromJson(json["default"]),
        medium:
            null == json["medium"] ? null : Default.fromJson(json["medium"]),
        high: null == json["high"] ? null : Default.fromJson(json["high"]),
